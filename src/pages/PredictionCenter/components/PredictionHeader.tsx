        ...
        >
            ...
            <div className="relative z-10 flex justify-between items-start gap-8">
                <div className="max-w-2xl">
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-3" style={{ background: 'linear-gradient(135deg, #e1e8ff 0%, #c0d4ff 50%, #a0c0ff 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
                        Employee Attrition Prediction Center
                    </h2>
                    <p className="text-on-surface-variant text-sm leading-relaxed opacity-80 max-w-xl">

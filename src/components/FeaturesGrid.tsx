...
export function FeaturesGrid() {
  return (
    <section id="features" className="py-16 sm:py-24 border-b border-border-primary/60 bg-primary-bg">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {features.map((feature, i) => {
            ...
            return (
              <div 
                key={i} 
                className="bg-secondary-bg/50 border border-border-primary/60 p-5 sm:p-6 rounded flex flex-col justify-between transition-all duration-300 hover:border-accent-blue/55 group"
              >
                <div>
                  {/* Top Bar inside Card */}
                  <div className="flex items-center justify-between border-b border-border-primary/60 pb-3 sm:pb-4 mb-4 sm:mb-5">
                    <span className="font-mono text-[9px] text-accent-blue tracking-widest uppercase font-bold">
                      {feature.codeLabel}
                    </span>
                  ...
                  {/* Title & Desc */}
                  <h3 className="font-bold text-sm sm:text-base text-white mb-2 group-hover:text-accent-blue transition-colors duration-200">
                    {feature.title}
                  </h3>
                ...
                {/* Sub-label */}
                <div className="mt-5 sm:mt-6 pt-3 border-t border-border-primary/60 flex items-center justify-between font-mono text-[9px] text-slate-600">
